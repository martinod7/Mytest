...
Runjump.Game.prototype = {
	...
	create: function() {
		...
		this.add.sprite(0, 0, 'background5');
		...
		this.pipes.createMultiple(11, 'enemies1');
	...
	hit_pipe: function() {
        ...
        //this.explosion = player.animations.add('explosion');
		//this.explosion.animations.play('walk', 5, true);
		//this.explosion.onUpdate.add(onUpdate, this);
